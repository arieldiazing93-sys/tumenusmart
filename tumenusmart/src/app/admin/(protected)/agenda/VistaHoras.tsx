          ...
          return (
            <div
              ...
              className={`sticky top-0 z-30 flex items-center justify-center border-b border-l border-linea px-1 py-2 ${
                esHoy ? "bg-brand-light" : "bg-superficie"
              }`}
            >
              {n === 1 ? (
                <p
                  className={`rounded-full px-3 py-1 text-[0.9rem] font-semibold ${
                    esHoy ? "bg-brand text-white" : "text-tinta"
                  }`}
                >
                  {diaLargo(dia)}
                </p>
                ...
                >
                  <span
                    className={`text-[0.68rem] font-semibold uppercase tracking-wide ${
                      esHoy ? "text-brand-texto" : "text-tinta-suave"
                    }`}
                  >
                    {diaCorto(dia)}
                  </span>
                  <span
                    className={`flex h-7 min-w-7 items-center justify-center rounded-full px-1 text-[0.95rem] font-semibold transition-colors ${
                      esHoy ? "bg-brand text-white" : "text-tinta group-hover:bg-papel-hundido"
                    }`}
                  >
                    {numeroDeDia(dia)}
                  </span>
          ...
          return (
            <div
              ...
              className={`relative border-l border-linea ${
                esHoy ? "bg-brand-light/20" : esFinDeSemana(dia) ? "bg-papel-suave" : "bg-superficie"
              }`}
