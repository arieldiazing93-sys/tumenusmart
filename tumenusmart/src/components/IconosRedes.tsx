...
/**
 * WhatsApp en línea: el globo de diálogo con el tubo del teléfono adentro. Es del
 * mismo trazo que los demás iconos de redes (el WhatsApp relleno del panel
 * quedaba grande y de otro estilo al lado de Instagram o Facebook).
 */
export const IconoWhatsappLinea = (p: Props) => (
  <Svg {...p}>
